...
class UpcomingDetailViewController: BaseViewController {
    ...
    */
    @IBAction func onCancelButtonAction(_ sender: Any) {
        var alertController = UIAlertController(title: "", message: APPLocalize.localizestring.cancelOrder.localize(), preferredStyle: .alert)
        
        var no = UIAlertAction(title: APPLocalize.localizestring.no.localize(), style: .default, handler: nil)
        
        var ok = UIAlertAction(title: APPLocalize.localizestring.yes.localize(), style: .default, handler: { action in
...
extension UpcomingDetailViewController{
    ...
    private func setTitle(){
        orderDeliveryTimeLabel.text = APPLocalize.localizestring.oderDeliveryTime.localize()
        enterOrderPreparationTime.text = APPLocalize.localizestring.enterPreparationTime.localize()
        ...
        acceptButton.setTitle(APPLocalize.localizestring.accept.localize(), for: .normal)
        cancelButton.setTitle(APPLocalize.localizestring.cancel.localize(), for: .normal)
        acceptTimeButton.setTitle(APPLocalize.localizestring.accept.localize(), for: .normal)
