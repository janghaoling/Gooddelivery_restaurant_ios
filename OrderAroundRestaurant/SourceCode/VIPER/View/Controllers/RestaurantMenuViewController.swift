...
extension RestaurantMenuViewController {
    ...
    private func setValueSideMenu(){
        self.menuTitleArr = [APPLocalize.localizestring.history.localize(),APPLocalize.localizestring.editRestaurant.localize(),APPLocalize.localizestring.editTiming.localize(),APPLocalize.localizestring.Deliveries.localize(),APPLocalize.localizestring.changeLanguage.localize(),APPLocalize.localizestring.changePassword.localize(),APPLocalize.localizestring.logout.localize(),APPLocalize.localizestring.deleteAccount.localize()]
        self.menuImgArr = ["timer","edit","edit-time","delivery-truck","language","padlock","logout","trash"]
    }
...
extension RestaurantMenuViewController: UITableViewDelegate,UITableViewDataSource{
    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        if indexPath.row == 0 {
            ...
            let languageController = self.storyboard?.instantiateViewController(withIdentifier: Storyboard.Ids.ChangeLanguageViewController) as! ChangeLanguageViewController
