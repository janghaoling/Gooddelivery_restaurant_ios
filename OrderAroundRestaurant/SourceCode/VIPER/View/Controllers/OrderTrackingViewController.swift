...
extension OrderTrackingViewController{
    ...
    private func setTitle(){
        orderPlaceLabel.text = APPLocalize.localizestring.orderReceived.localize()
        orderPlaceDescrLabel.text = APPLocalize.localizestring.description1.localize()
        orderConfirmedLabel.text = APPLocalize.localizestring.orderConfirmed.localize()
        orderConfirmDescrLabel.text = APPLocalize.localizestring.description2.localize()
        orderProcessLabel.text = APPLocalize.localizestring.orderProcessed.localize()
        orderProcessDescrLabel.text = APPLocalize.localizestring.description3.localize()
        orderPickedupLabel.text = APPLocalize.localizestring.orderPickedUp.localize()
        orderPickedupDescrLabl.text = APPLocalize.localizestring.description4.localize()
        orderfDeliveredLabel.text = APPLocalize.localizestring.orderDelivered.localize()
        orderDeliveredDescrLabel.text = APPLocalize.localizestring.description5.localize()
        ...
        OrderListLabel.text = APPLocalize.localizestring.orderList.localize()
        noteLabel.text = APPLocalize.localizestring.notes.localize()
    }
    ...
    private func fetchOrderDetails(data: Order) {
        ...
        totalValueLabel.text = currency + String(format: " %.02f", Double(subTotalStr) ?? 0.0)
